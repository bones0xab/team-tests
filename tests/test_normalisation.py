...
class TestNormalizeIssue:
    ...
    def test_normalize_issue_no_assignee(self):
        ...
        assert result["assignee"] is None, "Assignee devrait être None"
    ...
    def test_normalize_issue_status_category(self):
        ...
        # Vérifier que status_category existe et est une string
    ...
    def test_normalize_issue_days_since_update(self):
        # Créer un ticket mis à jour il y a 5 jours
        ...
        # days_since_update devrait être environ 5
        assert result["days_since_update"] >= 4, "Devrait être >= 4 jours"
        assert result["days_since_update"] <= 6, "Devrait être <= 6 jours"
    ...
    def test_normalize_issue_timezone_with_colon(self):
        raw_issue = {
            ...
            "fields": {
                ...
                "assignee": None,
                "updated": "2025-02-12T08:00:00+01:00"  # Déjà bon format
            }
        }
        ...
        assert isinstance(result["updated_at"], datetime)
        assert result["updated_at"].tzinfo is not None, "Timezone devrait être définie"
...
class TestNormalizeIssueEdgeCases:
    def test_normalize_issue_today(self):
        ...
        assert result["days_since_update"] == 0, "Devrait être 0 jour"
    ...
    def test_normalize_issue_days_not_negative(self):
        # Utiliser une date très récente (quelques secondes avant maintenant)
        ...
        # Même si mise à jour il y a quelques secondes, days_since_update >= 0
        assert result["days_since_update"] >= 0, "Ne devrait jamais être négatif"
...
class TestNormalizeIssueRobustness:
    def test_normalize_handles_multiple_timezone_formats(self):
        timezone_formats = [
            ...
            "2025-02-12T10:00:00-05:00",  # Timezone négative standard
            "2025-02-12T10:00:00-0500",   # Timezone négative Jira
